...
if __name__ == '__main__':
    ...
    worksheet.write(0, 42, 'PSM2_joint_1')
    worksheet.write(0, 43, 'PSM2_joint_2')
    worksheet.write(0, 44, 'PSM2_joint_3')
    worksheet.write(0, 45, 'PSM2_joint_4')
    worksheet.write(0, 46, 'PSM2_joint_5')
    worksheet.write(0, 47, 'PSM2_joint_6')
    worksheet.write(0, 48, 'PSM2_jaw_angle')
    worksheet.write(0, 49, 'PSM2_ee_x')
    worksheet.write(0, 50, 'PSM2_ee_y')
    worksheet.write(0, 51, 'PSM2_ee_z')

    worksheet.write(0, 52, 'PSM2_Orientation_Matrix_[1,1]')
    worksheet.write(0, 53, 'PSM2_Orientation_Matrix_[1,2]')
    worksheet.write(0, 54, 'PSM2_Orientation_Matrix_[1,3]')

    worksheet.write(0, 55, 'PSM2_Orientation_Matrix_[2,1]')
    worksheet.write(0, 56, 'PSM2_Orientation_Matrix_[2,2]')
    worksheet.write(0, 57, 'PSM2_Orientation_Matrix_[2,3]')

    worksheet.write(0, 58, 'PSM2_Orientation_Matrix_[3,1]')
    worksheet.write(0, 59, 'PSM2_Orientation_Matrix_[3,2]')
    worksheet.write(0, 60, 'PSM2_Orientation_Matrix_[3,3]')
    ...
    def callback_dummy(data):
        ...
        if PSM2_jaw_angle[0] < 0:
            PSM2_jaw_angle[0] = 0
        PSM2_jaw_angle = [PSM2_jaw_angle[0]]

        PSM2_ee = PSM2.get_current_cartesian_position()
        PSM2_Orientation_Matrix = PSM2.get_current_orientation_matrix()
        PSM2_data = np.concatenate((PSM2_jp, PSM2_jaw_angle, PSM2_ee, PSM2_Orientation_Matrix), axis = 0)
        ...
        all_data = np.concatenate((PSM1_data, MTMR_data, PSM2_data, MTML_data, ECM_data, footpedal_data), axis = 0)
