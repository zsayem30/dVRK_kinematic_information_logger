...
if __name__ == '__main__':
	...
	workbook = xlsxwriter.Workbook('Ground_Truth_sinx_axis.xlsx')
	...
	rospy.Subscriber('PSM1/measured_cp', TransformStamped, callback_dummy, queue_size = 1, buff_size = 1000000)
